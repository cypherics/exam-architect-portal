...
import { defaultSection } from "@/hooks/useSectionManager";

export interface useExamCreationEditionProps {
  state: {
    savedExams: any[];
    examDetails: any;
    sections: any[];
 ...
 */
export const useExamCreationEdition = (): useExamCreationEditionProps => {
